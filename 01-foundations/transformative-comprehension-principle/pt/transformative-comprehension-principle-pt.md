...
* Documento fundacional de orientação estrutural
* Não é licença
* Não é manifesto
* Não é manual
* Não é política institucional
...
### 2.1 — Quem é o Leitor Legítimo

* Leitor como posição estrutural
* Legitimidade não por status, mas por postura

### 2.2 — Condições de Acesso Interpretativo
...
**Este documento não pode ser tratado como:**
...
### 6.1 — O que significa atravessar o limiar

* Compreensão que altera posição
* Fim da neutralidade

### 6.2 — Irreversibilidade Estrutural
...
> *“Ao prosseguir, reconheço que já não sou neutro em relação a este Sistema.”*
...
**Aqui o Sistema se fecha — não para impedir, mas para preservar.**

* O Sistema está vivo
* A compreensão já é relação
* A responsabilidade começa antes do uso
